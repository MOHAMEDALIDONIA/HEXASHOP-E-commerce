    ...
    <div class="row">
      ...
      @endif
        <div class="col-md-12 grid-margin stretch-card">
            ...
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Add Color
                  <a href="{{url('admin/color')}}" class="btn btn-danger btn-m text-white float-end">Back</a> 
                </h4>
                <hr>
                <form class="forms-sample" action="{{url('admin/colors/store')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="form-group">
                    <label >Code</label>
                    <input type="text" class="form-control text-white"  name="code" placeholder="code->(name or  # code css)">
                    @error('code')
                    <small class="form-text text-danger">{{$message}}</small> 
                    @enderror
                  </div>
